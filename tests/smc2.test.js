...
const READER = path.join(ROOT, 'scripts', 'read_smc2.py');
...
const samples = [
  { name: 'Studio 1.66 (JSON ladder)', file: path.join(ROOT, 'mdf ats new.smc2'), minRungs: 1000, wantVars: true },
  { name: 'Studio 1.56 (XML ladder)',
    file: 'C:/Users/tw/Downloads/pressfitting & lathing/lathing.smc2', minRungs: 500, wantVars: false },
];
