...
if (typeof require !== 'undefined') {
  var { rungNet } = require('./net.js');
  var { rungExpr } = require('./ladder.js');
}
...
if (typeof module !== 'undefined') {
  module.exports = { exportProject, exportReport, rungToXml, holeRung, baseName, safeName };
}
