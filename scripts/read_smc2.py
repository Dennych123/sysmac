...
container ZIP berisi XML, jadi isinya tetap bisa dibaca dari luar.
  ...
  python scripts/read_smc2.py project.smc2            # ringkasan
  python scripts/read_smc2.py project.smc2 --json out.json
  python scripts/read_smc2.py project.smc2 --operands # inventaris operand + komen
